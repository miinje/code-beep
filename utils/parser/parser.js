...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$literalExpectation("function", false);
  ...
  var peg$e18 = peg$otherExpectation("whitespace (at least one)");

  var peg$f0 = function(name, params, body) {
      return {
  ...
  var peg$f1 = function(keyword, name, params, body) {
      return {
        type: "FunctionDeclaration",
        name: name,
        parameters: params ? params : [],
  ...
  var peg$f2 = function(keyword, name, params, body) {
  ...
  var peg$f3 = function() { return "var"; };
  var peg$f4 = function() { return "let"; };
  var peg$f5 = function() { return "const"; };
  ...
  var peg$f10 = function() { return text().trim(); };
  var peg$f11 = function() { return { type: "ignored" }; };
  var peg$f12 = function() { return { type: "ignored" }; };
  ...
  function peg$parseVariableKeyword() {
    var s0, s1;
  ...
  function peg$parseNestedFunction() {
