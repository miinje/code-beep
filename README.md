...
- [구현 기능](#구현-기능)
	...
	- [2. 알람 시간 감지해서 사용자에게 알려 주기](#2-알람-시간-감지해서-사용자에게-알려-주기)
		- [[1] React Native 라이브러리로 백그라운드 작업하기](#1-react-native-라이브러리로-백그라운드-작업하기)
			...
			- [(2) react-native-background-action 사용해 작업하기](#1-react-native-background-action-사용해-작업하기)
		- [[2] 백그라운드에서 시간 확인하기](#2-백그라운드에서-시간-확인하기)
- [개선할 사항](#개선할-사항)
	- [1. 다양한 프로그래밍 언어 분석하기](#2-다양한-프로그래밍-언어-분석하기)
		- [[1] 이 애플리케이션의 한계점: 자바스크립트만 가능하다](#1-이-애플리케이션의-한계점-자바스크립트만-가능하다)
		- [[2] 프로그래밍 언어의 공통점 찾기](#2-프로그래밍-언어의-공통점-찾기)
  - [2. 스케줄로 알람 예약하기](#1-스케줄로-알람-예약하기)
    - [[1] 제한없는 Foreground Services로 인한 ANR 에러](#1-1-foreground-services로-인한-anr-에러)
    - [[2] Alarm Manager를 이용해 알람 예약하기](#1-2-alarm-manager를-이용해-알람-예약하기)
- [개인 회고](#개인-회고)
